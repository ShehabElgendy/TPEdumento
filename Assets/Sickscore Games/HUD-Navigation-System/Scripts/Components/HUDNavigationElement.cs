...
namespace SickscoreGames.HUDNavigationSystem
{
    ...
    public class HUDNavigationElement : MonoBehaviour
    {
        ...
        // EVENTS
        public NavigationElementEvent OnElementReady = new();
        public NavigationUpdateEvent OnElementUpdate = new();
        public NavigationTypeEvent OnAppear = new();
        public NavigationTypeEvent OnDisappear = new();
        public NavigationTypeEvent OnEnterRadius = new();
        public NavigationTypeEvent OnLeaveRadius = new();
